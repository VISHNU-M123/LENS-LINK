...
const ServiceForm = ({heading, subHeadingCategory, mode='add',}) => {
  return (
    <div>
                    ...
                    <div className='py-[28px] px-[25px]'>
                        ...
                        <form action="">
                            <div className='mb-[40px]'>
                                ...
                                <input type="text" className={`h-[41.2px] border text-[14px] font-normal py-[10px] px-[11px] bg-[#2A3038] rounded-[2px] text-white leading-none w-full block outline-none border-[#2c2e33]`} placeholder='Category Name' />
                            ...
                            <div className='mb-[40px]'>
                                ...
                                <input type="text" name='categoryDescription' className={`h-[41.2px] border text-[14px] font-normal py-[10px] px-[11px] bg-[#2A3038] rounded-[2px] text-white leading-none w-full block outline-none border-[#2c2e33]`} placeholder='Category Description' />
